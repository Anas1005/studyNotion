...
import { removeCurrentUser, setCurrentUser } from '../../../slices/profileSlice'
    ...
    <div>
      <button className='relative' onClick={() => setModalOpen(true)} >
        ...
        <div className='flex gap-x-1 items-center' >
          <img src={currentUser?.image} className='w-[30px] rounded-full aspect-square object-cover' alt="user-avatar" />

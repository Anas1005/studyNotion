...
export const CourseInformation = () => {
  ...
  const handleNext = async () => {
    try {
      ...
      toast.success("Kr Diya Course cREATE");
        ...
        <form className="grid grid-cols-1 gap-4 rounded-lg p-4 w-full">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center">
              <span className="text-white text-xl mr-1 rounded-lg px-4 py-1.5  bg-white bg-opacity-10 backdrop-blur-md">₹</span>
              <input
          ...
          <div className="flex flex-col">
            ...
            <select
              ...
              onChange={(e) => {
                ...
                setSelectedCategoryName(selectedOption.textContent);

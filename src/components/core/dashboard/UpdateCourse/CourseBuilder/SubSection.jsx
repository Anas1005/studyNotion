...
export const SubSection = ({ sectionID, setSections, toggleSubSectionModal}) => {
  ...
  const handleSave = async () => {
    try {
      ...
      await createSubSection({...subsectionData,sectionID,courseID:currentCourse._id}, token, dispatch);
    ...
    <div className="rounded-lg p-4 w-full mx-[25%]">
      ...
      <div className="custom-scrollbar max-h-80">
        ...
        <div className="flex flex-col mt-2">
          <label htmlFor="subsectionDescription" className="text-white mb-1">
            Lecture Description
          </label>
          <textarea
          ...
          >
            {subsectionData.videoFile ? (
              ...
              <div className="flex flex-col items-center justify-center gap-3">
                ...
                <span>
                  Click to <span className="text-yellow-25">Browse</span> a file
                </span>
              </div>
            )}
            <input

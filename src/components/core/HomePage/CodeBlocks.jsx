...
export const CodeBlocks = ({ flexDir, heading, subHeading, ctaBtn1, ctaBtn2, codeText, codeColor, noOfLines, codeBlockId }) => {
  ...
  return (
    <div className={`flex flex-col items-center ${flexDir} my-20 justify-between gap-10 `} >
      {/* Section 1 - left */}
